use crate::{SchemaValidationError, ToolDeclaration, ToolId, ToolSchema};
use agl_content::Content;
use agl_ids::{RunId, TurnId};
use serde::{Deserialize, Serialize};

use crate::{TurnHookBatch, TurnMessage};
...
impl TurnInput {
    ...
    pub fn with_tool_policy_hash(mut self, policy_hash: impl Into<String>) -> Self {
        self.tool_policy_hash = Some(policy_hash.into());
        self
    }
}
