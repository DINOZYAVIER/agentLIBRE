...
use args::{
    ...
    NotesSearchOptions, NotesShowOptions, NotesUpdateOptions, RunOptions, ServeOptions,
    SkillCommand, SkillInspectOptions, SkillListOptions, SkillListSourceArg, SkillLockOptions,
