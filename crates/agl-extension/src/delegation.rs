...
use crate::{EffectId, ExtensionDescriptor, ExtensionId, OperationKind, ToolDeclaration, ToolId};
...
pub fn delegation_provider() -> ExtensionDescriptor {
    ...
    .with_tool(
        ToolDeclaration::from_schema::<DelegateActionArgs>(
            ToolId::new(AGENT_DELEGATE_TOOL_ID).expect("builtin delegation capability id is valid"),
