...
static_assert(std::is_same_v<decltype(llama_model_params::devices), ggml_backend_dev_t *>,
              "llama_model_params.devices ABI changed");
static_assert(std::is_same_v<decltype(llama_model_params::n_gpu_layers), int32_t>,
              "llama_model_params.n_gpu_layers ABI changed");
static_assert(std::is_same_v<decltype(llama_model_params::tensor_split), const float *>,
              "llama_model_params.tensor_split ABI changed");
...
static_assert(std::is_same_v<decltype(llama_context_params::n_ctx), uint32_t>,
              "llama_context_params.n_ctx ABI changed");
static_assert(std::is_same_v<decltype(llama_context_params::n_threads), int32_t>,
              "llama_context_params.n_threads ABI changed");
static_assert(std::is_same_v<decltype(llama_context_params::rope_freq_base), float>,
              "llama_context_params.rope_freq_base ABI changed");
static_assert(std::is_same_v<decltype(llama_context_params::type_k), ggml_type>,
              "llama_context_params.type_k ABI changed");
static_assert(std::is_same_v<decltype(llama_context_params::type_v), ggml_type>,
              "llama_context_params.type_v ABI changed");
static_assert(std::is_same_v<decltype(llama_context_params::kv_unified), bool>,
              "llama_context_params.kv_unified ABI changed");
static_assert(std::is_same_v<decltype(llama_context_params::n_samplers), size_t>,
              "llama_context_params.n_samplers ABI changed");

static_assert(std::is_same_v<decltype(&llama_model_default_params), llama_model_params (*)()>,
              "llama_model_default_params signature changed");
static_assert(std::is_same_v<decltype(&llama_context_default_params), llama_context_params (*)()>,
              "llama_context_default_params signature changed");
static_assert(std::is_same_v<decltype(&llama_batch_get_one), llama_batch (*)(llama_token *, int32_t)>,
              "llama_batch_get_one signature changed");
static_assert(std::is_same_v<decltype(&llama_decode), int32_t (*)(llama_context *, llama_batch)>,
              "llama_decode signature changed");
static_assert(
    std::is_same_v<decltype(&llama_set_abort_callback), void (*)(llama_context *, ggml_abort_callback, void *)>,
    "llama_set_abort_callback signature changed");
