...
pub fn first_party_runtime_features() -> &'static [RuntimeFeature] {
    &[
        ...
        RuntimeFeature {
            ...
            requires: &["trusted pinned Git package source for workspace skills"],
            model_tools: &[],
        },
        RuntimeFeature {
            id: "repo",
            title: "Repo workspace",
            summary: "workspace init, hooks, and task Artifact verification",
            read_only_actions: &["verify tasks"],
            write_actions: &["init", "install-hooks"],
            commands: &["agl init", "agl install-hooks", "agl repo verify-tasks"],
